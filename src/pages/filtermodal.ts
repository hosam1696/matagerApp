  ...
  template: `
    <ion-header>
      ...
      <button ion-button class="close-btn" (click)="closeModal()">
        ...
        <ion-buttons >
          <button ion-button class="close-btn" (click)="backModal()">
        رجوع
          </button>
        </ion-buttons>
...
export class PlacesModal {
  ...
  backModal(): void {
    console.log('backModal', this.modalNum, this.finalResult);
    if (this.modalNum === 1) {

      this.modalNum = 0;
      this.choosenParent = 0;
    //  this.finalResult.areaId = null;
    //  this.finalResult.areaName = null;
      this.closeModal();
    } else if (this.modalNum === 2) {
      this.modalNum = 1;
      this.choosenParent = 0;
    // this.finalResult.cityId = null;
     // this.finalResult.cityName = null;
      console.log('this.modalNum=', this.modalNum);
    } else if (this.modalNum === 3) {
      this.modalNum = 2;
    //  this.choosenParent = this.finalResult.parent;
      //this.finalResult.distId = null;
     // this.finalResult.distName = null;
      console.log('this.modalNum=', this.modalNum);
    }
   // this.navCtrl.pop();
 //   this.navCtrl.push('PlacesModal', { data: this.finalResult });
    (this.modalNum == 0) ? this.closeModal() : this.fetchAreaCallback(true);
  ...
  openNewModal(choosenPlace: Iplace): void {
    ...
    console.log('for testing=', this.modalNum, this.finalResult); // for testing
    this.navCtrl.push('PlacesModal', { data: this.finalResult });
